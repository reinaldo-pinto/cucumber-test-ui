...
Cenário: Pesquisar voos
    Dado que eu acesso a pagina de Login
    E eu incluo o usuário inválido "teste" e senha válida "teste" 
    Quando seleciono o tipo de voo Round Trip   
    E preencher as informacoes e continuar
    Então apresentado o resultado dos voos
